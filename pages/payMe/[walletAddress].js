  ...
  let isMounted = true;
    ...
    if (walletAddress) {
      ...
      (async function() {
        ...
        setReciversTokenIfo(returnData.vendorData);
        setReciversToken(returnData.vendorData.vendorsToken);
        // setReciver(walletAddress);
        setReciver(vendorsWalletAddress);
        setUserData(returnData.vendorData);
        setAddressIsVendor(true)
        dispatchather({type:"FOUND"})
        console.log('.done dispensing data....')
