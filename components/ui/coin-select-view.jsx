...
export default function CoinSelectView({ onSelect }) {
  ...
  async function  getSendersCoinList() {
    ...
    let newCoinList = [];
    for (let i = 0; i<sendersCoinList.length;) {
...
// },
    ...
    let coinListData = sendersCoinList;
    if (searchKeyword.length > 0) {
        coinListData = sendersCoinList.filter(function (item) {
