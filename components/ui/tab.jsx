...
//
export function TabItem({ children, className, }) {
    return (<Tab className={({ selected }) => cn('relative py-2 uppercase tracking-wider hover:text-gray-900 focus:outline-none dark:hover:text-gray-100 xs:py-2.5 sm:py-3', {
...
export function TabPanels({ children, className, }) {
    return (<Tab.Panels className={className}>
