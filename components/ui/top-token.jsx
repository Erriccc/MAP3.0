...
export default function TopToken() {
    return (<div className="rounded-lg bg-white p-8 shadow-large">
      ...
      {TopTokensData.map((token, index) => (<div className="mb-5 grid grid-cols-3 gap-4 text-sm text-gray-900 last:mb-0" key={index}>
