...
export default function TransactionRecieptModal({  confirmationTitle, txReciept, setTxReciept }) {
    ...
    <span className="h-1/5 align-middle" aria-hidden="true">
        ...
        {/* <div className="relative z-50 mx-auto max-w-full rounded-lg bg-white px-9 py-16 dark:bg-light-dark" > */}
              ...
              <ActiveLink href={`${Utils.providerBlockExplorer}tx/${txReciept.hash}`} className="mt-10 flex h-14 w-1/2 mx-auto cursor-pointer items-center justify-center rounded-lg bg-blue-200 ">
                view confirmation
            </ActiveLink>
