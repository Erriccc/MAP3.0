      ...
      <Menu>
        ...
        <Transition as={Fragment} enter="ease-out duration-300" enterFrom="opacity-0 translate-y-4" enterTo="opacity-100 translate-y-0" leave="ease-in duration-300" leaveFrom="opacity-100 translate-y-0" leaveTo="opacity-0 translate-y-4">
          <Menu.Items className="absolute z-20 mt-5 w-60 origin-top-right rounded-lg bg-white py-3 shadow-large ltr:right-0 rtl:left-0 dark:bg-gray-800">
            <div className="px-3">
              <Menu.Item>
                <AnchorLink href="/" className="block rounded-lg px-3 py-2 text-sm font-medium uppercase text-gray-900 transition hover:bg-gray-50 dark:text-white dark:hover:bg-gray-700">
                  Place floor bid
              ...
              <Menu.Item>
                <AnchorLink href="/profile" className="block rounded-lg px-3 py-2 text-sm font-medium uppercase text-gray-900 transition hover:bg-gray-50 dark:text-white dark:hover:bg-gray-700">
                  New bid
                </AnchorLink>
              </Menu.Item>
            </div>
