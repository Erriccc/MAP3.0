...
export default function VoteActions({ title, action }) {
    return (<>
      <h4 className="mb-6 uppercase dark:text-gray-100">{title}</h4>
      {action?.map((item, index) => (<div key={item.id} className="mt-6">
          <div className="flex items-start gap-3">
            ...
            <div className="grid gap-4">
              <div className="flex items-start gap-1">
                ...
                <a href={item.contract.link} className="inline-flex items-center gap-1.5 font-medium hover:underline hover:opacity-90 focus:underline focus:opacity-90 dark:text-gray-300">
