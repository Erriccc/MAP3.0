...
export default function DrawersContainer() {
    ...
    return (<Transition appear show={isOpen} as={Fragment}>
      ...
      {/* <Dialog as="div" className="fixed inset-0 z-40 overflow-hidden" onClose={closeDrawer}> */}
        ...
        <Transition.Child as={Fragment} enter="transform transition ease-out duration-300" enterFrom="-translate-x-full" enterTo="translate-x-0" leave="transform transition ease-in duration-300" leaveFrom="translate-x-0" leaveTo="-translate-x-full">
