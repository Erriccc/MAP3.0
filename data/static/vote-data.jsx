        ...
        action: [
            {
                ...
                inputs: '0x000000000000000000000000bd537257fad96e977b9e545be583bbf7028f30b900000000000000000000000000000000000000000000065a4da25d3016c00000',
            },
            {
                id: uuidv4(),
                contract: {
...
export function getVotesByStatus(status) {
    const votesByStatus = map3Votes.filter((vote) => vote.status === status);
    return {
        votes: votesByStatus,
